...
async function isPromptFooInstalled(): Promise<boolean> {
...
async function installPromptFoo(): Promise<void> {
...
async function findModulePaths(): Promise<string[]> {
...
async function testModule(moduleName: string, customConfig?: string, verbose?: boolean): Promise<void> {
  try {
    const modulesPath = getContextModulesPath();
...
async function testAllModules(customConfig?: string, verbose?: boolean): Promise<void> {
  try {
