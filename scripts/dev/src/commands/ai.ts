 ...
 */
async function solveWithAI(query: string, options: { model?: string, context?: boolean }) {
 ...
 */
async function generateWithAI(type: string, name: string, options: { model?: string, context?: boolean }) {
 ...
 */
async function reviewWithAI(target: string, options: { model?: string, context?: boolean }) {
