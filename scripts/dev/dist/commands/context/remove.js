...
import { getActiveContext, removeModulesFromActiveContext } from '../../utils/contextModules.js';
...
export const removeCommand = new Command('remove')
    ...
    try {
        ...
        const modulesToRemove = modulePaths.filter((path) => activeContext.modules.includes(path));
        ...
        logger.error('Error removing modules', error);
    }
});
