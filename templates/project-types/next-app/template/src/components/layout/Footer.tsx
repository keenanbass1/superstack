    ...
    <footer className="bg-gray-50 dark:bg-gray-800 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">{{projectName}}</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="https://nextjs.org/docs" className="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                  Next.js Docs
                </Link>
              </li>
              <li>
                <Link href="https://tailwindcss.com/docs" className="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                  Tailwind CSS
                </Link>
              </li>
              <li>
                <Link href="https://react.dev" className="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">
                  React
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <p className="mt-2">
            ...
            using the Superstack Developer Workflow
          </p>
        </div>
      </div>
    </footer>
